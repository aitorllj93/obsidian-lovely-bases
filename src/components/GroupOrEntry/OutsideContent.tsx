...
const CellOutsideContent = ({
  ...
  const { groupTitlePosition, groupCounterPosition } = groupConfig ?? {};

  const shouldShowTitle =
    groupTitlePosition === "outside" && typeof title !== "undefined";
...
export default CellOutsideContent;
