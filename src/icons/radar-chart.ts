...
export const RADAR_CHART_ICON_ID = "lovely-radar-chart";

export const RADAR_CHART_ICON_SVG = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
